...
* add-notifications-framework-slack: Notifications are individually configurable and disabled by default; webhook URL is set via `SLACK_WEBHOOK_URL` environment variable.
