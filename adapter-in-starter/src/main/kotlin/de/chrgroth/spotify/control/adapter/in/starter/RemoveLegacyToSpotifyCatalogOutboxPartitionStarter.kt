...
@ApplicationScoped
@Suppress("Unused")
class RemoveLegacyToSpotifyCatalogOutboxPartitionStarter(
  private val mongoClient: MongoClient,
  @param:ConfigProperty(name = "quarkus.mongodb.database")
  private val databaseName: String,
) : Starter {

  override val id = "RemoveLegacyToSpotifyCatalogOutboxPartitionStarter-v1"
  ...
  companion object : KLogging() {
    ...
    private const val LEGACY_PARTITION = "to-spotify-catalog"
  }
}
